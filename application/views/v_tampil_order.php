            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button class="btn" style="margin-bottom: 15px"><?php echo anchor('crud/tambah_order/', 'Tambah'); ?></button>
                                <button class="btn" style="margin-bottom: 15px"><?php echo anchor('crud/export_order/', 'Export to Excel'); ?></button>
                                <table class="table">
                                    <thead>
                                        <tr>
                                          <th scope="col">#</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a href="<?php echo base_url().'crud/edit_order/'.$d->id_order ?>"><i class="menu-icon ti-pencil"></i></a> |
                                          <a href="<?php echo base_url().'crud/hapus_order/'.$d->id_order; ?>"><i class="menu-icon ti-trash"></i></a>
                                         </td>
                                    </tr>
                                    <?php
                                     }
