                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a href="crud/edit_cust/<?php echo $d->id_customer ?>"><i class="menu-icon ti-pencil"></i></a> |
                                           <a href="crud/hapus_cust/<?php echo $d->id_customer ?>"><i class="menu-icon ti-trash"></i></a>
                                         </td>
                                    </tr>
                                    <?php
                                     }
