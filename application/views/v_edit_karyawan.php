                ...
                <div class="col-lg-12">
                 <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <form action="<?php echo base_url().'crud/update_karyawan'; ?>" method="post" class="">
                                <div class="form-group"><label for="nama" class=" form-control-label">ID</label><input type="text" id="id_karyawan" name="id_karyawan" placeholder="Masukkan Nama.." class="form-control" value="<?php echo $c->id_customer ?>" readonly="true"><span class="help-block">Please enter your name</span></div>
                                ...
                                <div class="form-group"><label for="alamat" class=" form-control-label">Alamat</label><input type="text" id="alamat" name="alamat" placeholder="Masukkan alamat.." class="form-control" value="<?php echo $c->alamat ?>"><span class="help-block">Please enter your address</span></div>
